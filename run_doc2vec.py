...
from src.analysers import Doc2VecAnalyser
from src.utils import load_and_preprocess_data


def main():
    parser = argparse.ArgumentParser(description='Find similar documents using Doc2Vec')
    ...
    analyser = Doc2VecAnalyser(documents)
